...
class TopAps {
  ...
  public function topAps( )
  {
    $num = 1;
    $query = $this->__fnConectar( )->prepare( "SELECT * FROM zp_cuentas INNER JOIN zp_datos ON id = id_cuenta ORDER BY ammopacks DESC LIMIT 15" );
    $query->execute( );
