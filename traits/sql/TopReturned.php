...
class TopEscapes {
  ...
  {
    $num = 1;
    $query = $this->__fnConectar( )->prepare( "SELECT * FROM zp_cuentas INNER JOIN ctf_rangos_venezuela ON zp_cuentas.id = id_cuenta ORDER BY flags_returned DESC LIMIT 15" );
    $query->execute( );
